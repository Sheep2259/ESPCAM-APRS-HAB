...
public:
     ...
     * @param latStr APRS-formatted latitude string (Part of prng seed).
     * @param lngStr APRS-formatted longitude string (Part of prng seed).
     ...
     */
    bool encodePacket(fs::FS &fs, const char* filename, const char* latStr, const char* lngStr, uint8_t seedC, uint8_t* outputBuf);
...
private:
    ...
    uint32_t hashSeeds(const char* latStr, const char* lngStr, uint8_t c);
